            ...
            <table class="text-gray-600 min-w-full divide-y divide-gray-200">
                <thead class="border-b border-gray-300 bg-gray-200">
                    <tr class="text-center text-sm font-bold text-gray-500 uppercase tracking-wider">
                        <th class="px-6 py-3">Fecha y hora de inicio</th>
                        <th class="px-6 py-3">Fecha y hora de fin</th>
                        <th class="px-6 py-3">Remuneración</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($items as $item)
                        <tr class="bg-gray-50">
                            <td class="px-6 py-4 text-sm text-center">{{ $item->fecha_hora_inicio }}</td>
                            <td class="px-6 py-4 text-sm text-center">{{ $item->fecha_hora_fin }}</td>
                            <td class="px-6 py-4 text-sm text-center">{{ $item->remuneracion }}</td>
