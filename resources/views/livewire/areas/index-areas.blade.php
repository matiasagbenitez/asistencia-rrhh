<div class="container py-6">
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Áreas de la empresa</h2>
                        ...
                        <tr class="bg-gray-50">
                            ...
                            <td class="px-6 py-3 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center justify-center gap-2">
                                    @livewire('areas.edit-area', ['area' => $area], key($area->id))
                                    <x-jet-danger-button wire:click="$emit('deleteArea', '{{ $area->id }}')">
            ...
            Livewire.on('deleteArea', areaId => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('areas.index-areas', 'delete', areaId);
